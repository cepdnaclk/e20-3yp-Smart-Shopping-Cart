...
const handleLoginSubmit = (e: React.FormEvent) => {
  ...
  if (validCredential) {
    ...
    setSuccess(`Welcome back, ${validCredential.storeName} (${validCredential.branch})!`);
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Design your store layout to enhance the shopping experience with smart navigation.
        </p>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            {isLogin ? "Don't have a store account?" : "Already have a store account?"}
            <button 
              onClick={() => {
                setIsLogin(!isLogin);
                setError('');
          ...
          {isLogin && (
            <div style={{
              ...
              {DEMO_CREDENTIALS.map((cred, index) => (
                <div key={index} style={{
                  marginBottom: index === DEMO_CREDENTIALS.length - 1 ? '0' : '5px'
                }}>
                  <strong>Store:</strong> {cred.storeName}, <strong>Branch:</strong> {cred.branch}, <strong>Password:</strong> {cred.password}
                </div>
              ))}
            </div>
          )}
